"""
Django settings for kotoba_quest_project project.
...
ROOT_URLCONF = 'kotoba_quest_project.urls'
...
WSGI_APPLICATION = 'kotoba_quest_project.wsgi.application'
...
# Django Allauth (temporarily disabled)
